...
const DashboardArtist = () => {
  ...
  return (
    <div className="w-full p-a flex items-center justify-center flex-col">
      <div className="relative w-full gap-3  my-4 p-10 py-12 px-7 border border-gray-300 rounded-md flex flex-wrap justify-evenly">
        {artists &&
