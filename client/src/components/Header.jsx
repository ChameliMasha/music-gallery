    ...
    <header className="flex items-center w-full p-4 md:py-2 md:px-6 ">
      ...
      >
        ...
        <div className="flex flex-col">
          <p className="text-textColor text-lg hover:font-semibold font-semibold">
            {user?.user.name}
          </p>
        ...
        {isMenu && (
          ...
          >
            <NavLink to={"/userProfile"}>
              <p className="text-base font-semibold  text-textColor hover:font-bold duration-150 transition-all ease-in-out">
                Profile
              </p>
            </NavLink>
            <p className="text-base  font-semibold  text-textColor hover:font-bold duration-150 transition-all ease-in-out">
            ...
            <p
              className="text-base font-semibold  text-textColor hover:font-bold duration-150 transition-all ease-in-out"
              onClick={logout}
            >
              Sign out
            </p>
